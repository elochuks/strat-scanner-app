...
st.write(
    "Scan S&P 500 stocks, curated ETFs, and major indexes "
    "for STRAT candle patterns."
)
...
if run_scan:
    ...
    if not previous_patterns and not current_patterns:
        ...
        st.warning(
            "Select at least one previous or current candle pattern."
        )
        ...
        for i, ticker in enumerate(scan_list):
            ...
            # STRAT TYPES
            # -----------------------------------------
            previous_type = strat_candle_type(
                previous_candle,
                prior_reference
            )

            current_type = strat_candle_type(
                current_candle,
                previous_candle
            )
            ...
            # -----------------------------------------
            previous_match = (
                previous_type in previous_patterns
            )

            current_match = (
                current_type in current_patterns
            )
